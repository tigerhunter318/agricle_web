...
@section('content')
    ...
    <form enctype='multipart/form-data' method="POST" action="{{ route('recruitments.update', $recruitment->id) }}" role="form" autocomplete="off" class="text-start" id="form">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <button type="button" class="btn btn-info m-1" id="edit_btn" onclick="save()"> <i class="fa fa-save"></i> {{__('messages.action.save')}} </button>
                <button type="button" class="btn btn-success m-1" onclick="javascript:history.go(-1);"> <i class="fa fa-arrow-left"></i>
